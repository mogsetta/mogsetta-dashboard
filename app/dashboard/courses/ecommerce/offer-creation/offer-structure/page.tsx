  ...
  return (
    <div style={{ padding: "48px 56px", maxWidth: 920 }}>
      ...
      <p style={{ opacity: 0.75, marginBottom: 32 }}>
        A clear product offer structure makes your solution easier to understand, easier to sell,
        and easier to fulfill. When the structure is clean, customers feel confident moving
      ...
      <section style={{ marginBottom: 40 }}>
        ...
        <p style={{ lineHeight: 1.6, opacity: 0.9 }}>
          Most product offers fail not because the solution is bad, but because the structure feels
      ...
      >
        ...
        <Link
          href="/dashboard/courses/ecommerce/offer-creation/offer-engineering"
          style={{
            textDecoration: "none",
            padding: "14px 22px",
            borderRadius: 10,
      ...
      <CoachChat
        ...
        description="Help structure your product offer into a clear, logical fulfillment and value system customers can easily understand and commit to."
      />
    </div>
  );
}
