  ...
  return (
    <div style={{ padding: "48px 56px", maxWidth: 920 }}>
      ...
      <p style={{ opacity: 0.75, marginBottom: 32 }}>
        A strong product solution is defined by the outcome it delivers, not the features it includes.
        Customers don’t buy tools or processes — they buy results. This step forces you to clearly
        define what success looks like for the customer before deciding how the product delivers it.
      </p>
      ...
      >
        ...
        <Link
          href="/dashboard/courses/ecommerce/offer-creation/offer-structure"
          style={{
            textDecoration: "none",
            padding: "14px 22px",
            borderRadius: 10,
      ...
      <CoachChat
        ...
        description="Clarify the outcome your product delivers and pressure-test whether it’s strong enough to support demand, margins, and repeat purchases."
      />
    </div>
  );
}