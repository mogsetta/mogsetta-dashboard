  ...
  return (
    <div style={{ padding: "48px 56px", maxWidth: 920 }}>
      ...
      <p style={{ opacity: 0.75, marginBottom: 32 }}>
        Learn how to design product offers that are clear, valuable, and easy to sell —
        before you spend time building products nobody wants to buy.
      </p>
      ...
      <section style={{ marginBottom: 40 }}>
        ...
        <p style={{ lineHeight: 1.6, opacity: 0.9 }}>
          Offer Creation is about choosing the right product idea, understanding real demand,
          and structuring an offer customers already want to buy.
          This course helps you avoid wasted inventory, unclear positioning, and weak demand.
        </p>
      </section>
